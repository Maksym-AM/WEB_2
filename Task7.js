...
let cl_1 = new  client('Maks', 'Andrushko', '2002-04-11', 20000);
let cl_2 = new  client('Andrii', 'Trump', '1996-04-17', 1000000);
let cl_3 = new  client('Spunch', 'Bob', '2010-08-13', 300);
let cl_4 = new  client('Donald', 'Duck', '1752-05-07', 5000);

let client_array = [cl_1, cl_2, cl_3];
let arr_2 = cl_1.delete(client_array);
let arr_3 = cl_4.add(client_array);
let finded_person = find_person('Donald', client_array);
...
let pr_1 = new project('Kalifornia', true, cl_3, doer_1);
let pr_2 = new project('SunInOurLife', false, cl_1, doer_2);
let pr_3 = new project('Helloween', false, cl_3, doer_1);
let pr_4 = new project('Crhristmas', true, cl_3, doer_2);
